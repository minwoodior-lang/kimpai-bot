      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            업비트·바이낸스 가격을 비교해{" "}
            <strong className="text-white">김치프리미엄</strong>을 즉시
            확인하고, AI 분석으로 시장 흐름을 예측하세요.
          </p>
        </div>
        ...
        <div className="mb-8">
          <PremiumTable showHeader={false} showFilters={true} limit={0} />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6">
            ...
            <ul className="text-slate-400 text-sm space-y-2">
              <li>
                <strong className="text-white">Upbit</strong> - 한국 최대 거래소
                실시간 API
              </li>
              <li>
                <strong className="text-white">Bithumb</strong> - 한국 2위
                거래소 API
              </li>
              <li>
                <strong className="text-white">Binance / OKX / Bybit</strong> -
                글로벌 거래소 실시간 데이터
              </li>
              <li>
                <strong className="text-white">TradingView</strong> - 고급 차트
                위젯
              </li>
            </ul>
          </div>
