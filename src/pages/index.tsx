    ...
    <section className="w-full border-b border-slate-800/60 bg-slate-950/40">
      <div className="max-w-[1440px] mx-auto px-4 lg:px-6 py-3 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-3 self-stretch lg:self-auto">
          <div className="rounded-xl bg-indigo-600/20 px-3 py-2">
          ...
          <button className="flex-1 lg:flex-none rounded-lg bg-indigo-500 px-3 py-2 text-[12px] font-semibold text-white hover:bg-indigo-600 transition-colors text-center">
            PRO 분석 전체 보기
          </button>
        </div>
      </div>
