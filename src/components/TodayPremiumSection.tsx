...
export function TodayPremiumSection({
  ...
  return (
    <div className="rounded-2xl border dark:border-slate-700/60 light:border-slate-300/40 dark:bg-slate-900/40 light:bg-slate-100/30 p-3 sm:p-4 h-full flex flex-col">
      {/* 제목 */}
      <h2 className="text-sm sm:text-base font-bold dark:text-slate-100 light:text-slate-900 mb-2 flex items-center gap-2">
        <span>📊</span>
      ...
      {/* Score 카드 */}
      <div className="mt-2 rounded-lg dark:bg-indigo-900/60 light:bg-indigo-100/60 px-3 py-1 flex items-center justify-center">
